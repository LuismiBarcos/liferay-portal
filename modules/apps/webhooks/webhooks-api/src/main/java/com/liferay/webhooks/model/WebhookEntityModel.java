...
/**
 * The base model interface for the WebhookEntity service. Represents a row in the &quot;Webhooks_WebhookEntity&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.webhooks.model.impl.WebhookEntityModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.webhooks.model.impl.WebhookEntityImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface WebhookEntityModel
	extends BaseModel<WebhookEntity>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a webhook entity model instance should use the {@link WebhookEntity} interface instead.
	 */
