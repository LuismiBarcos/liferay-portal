...
/**
 * The persistence utility for the webhook entity service. This utility wraps <code>com.liferay.webhooks.service.persistence.impl.WebhookEntityPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see WebhookEntityPersistence
 * @generated
 */
public class WebhookEntityUtil {
	 ...
	 */
	public static void clearCache(WebhookEntity webhookEntity) {
		getPersistence().clearCache(webhookEntity);
	}
	 ...
	 */
	public static Map<Serializable, WebhookEntity> fetchByPrimaryKeys(
	 ...
	 */
	public static List<WebhookEntity> findWithDynamicQuery(
	 ...
	 */
	public static WebhookEntity update(WebhookEntity webhookEntity) {
		return getPersistence().update(webhookEntity);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static WebhookEntity update(
		WebhookEntity webhookEntity, ServiceContext serviceContext) {

		return getPersistence().update(webhookEntity, serviceContext);
	}
	 ...
	 */
	public static List<WebhookEntity> findByUuid(String uuid) {
	 ...
	 */
	public static List<WebhookEntity> findByUuid(
	 ...
	 */
	public static WebhookEntity findByUuid_First(
			String uuid, OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {
	 ...
	 */
	public static WebhookEntity fetchByUuid_First(
		String uuid, OrderByComparator<WebhookEntity> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookEntityException if a matching webhook entity could not be found
	 */
	public static WebhookEntity findByUuid_Last(
			String uuid, OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {
	 ...
	 */
	public static WebhookEntity fetchByUuid_Last(
		String uuid, OrderByComparator<WebhookEntity> orderByComparator) {
	 ...
	 */
	public static WebhookEntity[] findByUuid_PrevAndNext(
			long webhookEntityId, String uuid,
			OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {

		return getPersistence().findByUuid_PrevAndNext(
			webhookEntityId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchWebhookEntityException if a matching webhook entity could not be found
	 */
	public static WebhookEntity findByUUID_G(String uuid, long groupId)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {
	 ...
	 */
	public static WebhookEntity fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching webhook entity, or <code>null</code> if a matching webhook entity could not be found
	 */
	public static WebhookEntity fetchByUUID_G(
	 ...
	 */
	public static WebhookEntity removeByUUID_G(String uuid, long groupId)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {
	 ...
	 * @return the matching webhook entities
	 */
	public static List<WebhookEntity> findByUuid_C(
	 ...
	 * @throws NoSuchWebhookEntityException if a matching webhook entity could not be found
	 */
	public static WebhookEntity findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {
	 ...
	 * @return the first matching webhook entity, or <code>null</code> if a matching webhook entity could not be found
	 */
	public static WebhookEntity fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<WebhookEntity> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookEntityException if a matching webhook entity could not be found
	 */
	public static WebhookEntity findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {
	 ...
	 * @return the last matching webhook entity, or <code>null</code> if a matching webhook entity could not be found
	 */
	public static WebhookEntity fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<WebhookEntity> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookEntityException if a webhook entity with the primary key could not be found
	 */
	public static WebhookEntity[] findByUuid_C_PrevAndNext(
			long webhookEntityId, String uuid, long companyId,
			OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {

		return getPersistence().findByUuid_C_PrevAndNext(
			webhookEntityId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching webhook entities
	 */
	public static List<WebhookEntity> findByGroupId(long groupId) {
	 ...
	 * @return the range of matching webhook entities
	 */
	public static List<WebhookEntity> findByGroupId(
	 ...
	 * @throws NoSuchWebhookEntityException if a matching webhook entity could not be found
	 */
	public static WebhookEntity findByGroupId_First(
	 ...
	 * @return the first matching webhook entity, or <code>null</code> if a matching webhook entity could not be found
	 */
	public static WebhookEntity fetchByGroupId_First(
		long groupId, OrderByComparator<WebhookEntity> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookEntityException if a matching webhook entity could not be found
	 */
	public static WebhookEntity findByGroupId_Last(
			long groupId, OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {
	 ...
	 * @return the last matching webhook entity, or <code>null</code> if a matching webhook entity could not be found
	 */
	public static WebhookEntity fetchByGroupId_Last(
		long groupId, OrderByComparator<WebhookEntity> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookEntityException if a webhook entity with the primary key could not be found
	 */
	public static WebhookEntity[] findByGroupId_PrevAndNext(
			long webhookEntityId, long groupId,
			OrderByComparator<WebhookEntity> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {

		return getPersistence().findByGroupId_PrevAndNext(
			webhookEntityId, groupId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(WebhookEntity webhookEntity) {
		getPersistence().cacheResult(webhookEntity);
	}
	 ...
	 */
	public static void cacheResult(List<WebhookEntity> webhookEntities) {
		getPersistence().cacheResult(webhookEntities);
	}
	 ...
	 */
	public static WebhookEntity create(long webhookEntityId) {
		return getPersistence().create(webhookEntityId);
	}
	 ...
	 * @throws NoSuchWebhookEntityException if a webhook entity with the primary key could not be found
	 */
	public static WebhookEntity remove(long webhookEntityId)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {

		return getPersistence().remove(webhookEntityId);
	}

	public static WebhookEntity updateImpl(WebhookEntity webhookEntity) {
		return getPersistence().updateImpl(webhookEntity);
	}
	 ...
	 * @throws NoSuchWebhookEntityException if a webhook entity with the primary key could not be found
	 */
	public static WebhookEntity findByPrimaryKey(long webhookEntityId)
		throws com.liferay.webhooks.exception.NoSuchWebhookEntityException {

		return getPersistence().findByPrimaryKey(webhookEntityId);
	}
	 ...
	 */
	public static WebhookEntity fetchByPrimaryKey(long webhookEntityId) {
		return getPersistence().fetchByPrimaryKey(webhookEntityId);
	}
	 ...
	 */
	public static List<WebhookEntity> findAll() {
	 ...
	 */
	public static List<WebhookEntity> findAll(int start, int end) {
	...
	public static WebhookEntityPersistence getPersistence() {
		return _persistence;
	}

	private static volatile WebhookEntityPersistence _persistence;
