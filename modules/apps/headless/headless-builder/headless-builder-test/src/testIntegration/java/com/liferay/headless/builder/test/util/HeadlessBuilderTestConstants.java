 ...
 */
public class HeadlessBuilderTestConstants {

	public static final String OBJECT_DEFINITION_ID = "!#objectDefinitionId#!";

	public static final String OBJECT_DEFINITION_NAME =
		"!#objectDefinitionName#!";

	public static final String OBJECT_DEFINITION_PLURAL_NAME =
		"!#objectDefinitionPluralName#!";
