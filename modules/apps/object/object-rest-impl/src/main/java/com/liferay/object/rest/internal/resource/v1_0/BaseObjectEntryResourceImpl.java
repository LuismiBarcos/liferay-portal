...
public abstract class BaseObjectEntryResourceImpl
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("{objectEntryId}/relationshipName/{relationshipName}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<ObjectEntry> getObjectEntryRelationshipNameRelationshipNamePage(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("relationshipName")
	...
	@javax.ws.rs.Path(
		"{objectEntryId}/relationshipName/{relationshipName}/relatedObject/{relatedObjectId}"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@javax.ws.rs.PUT
	@Override
	public ObjectEntry putObjectEntryRelationshipNameRelatedObject(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("relatedObjectId")
