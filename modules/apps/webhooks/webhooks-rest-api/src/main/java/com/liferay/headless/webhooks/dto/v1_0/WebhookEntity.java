...
@Generated("")
@GraphQLName(
	description = "Represents the entity which events will send to the Webhook specified",
	value = "WebhookEntity"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "WebhookEntity")
public class WebhookEntity implements Serializable {

	public static WebhookEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(WebhookEntity.class, json);
	}

	public static WebhookEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(WebhookEntity.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.webhooks.dto.v1_0.WebhookEntity",
		name = "x-class-name"
	)
