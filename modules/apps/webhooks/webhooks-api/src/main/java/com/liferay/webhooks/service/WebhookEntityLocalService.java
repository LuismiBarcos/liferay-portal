...
/**
 * Provides the local service interface for WebhookEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WebhookEntityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface WebhookEntityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.webhooks.service.impl.WebhookEntityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the webhook entity local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WebhookEntityLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public WebhookEntity addWebhookEntity(WebhookEntity webhookEntity);
	...
	public WebhookEntity createWebhookEntity(long webhookEntityId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public WebhookEntity deleteWebhookEntity(WebhookEntity webhookEntity);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WebhookEntity fetchWebhookEntity(long webhookEntityId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WebhookEntity fetchWebhookEntityByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WebhookEntity> getWebhookEntities(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WebhookEntity> getWebhookEntitiesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WebhookEntity getWebhookEntityByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WebhookEntity updateWebhookEntity(WebhookEntity webhookEntity);
