...
/**
 * The persistence utility for the webhook service. This utility wraps <code>com.liferay.webhooks.service.persistence.impl.WebhookPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WebhookUtil {
	 ...
	 */
	public static void clearCache(Webhook webhook) {
		getPersistence().clearCache(webhook);
	}
	 ...
	 */
	public static Map<Serializable, Webhook> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Webhook> findWithDynamicQuery(
	 ...
	 */
	public static Webhook update(Webhook webhook) {
		return getPersistence().update(webhook);
	}
	...
	public static Webhook update(
		Webhook webhook, ServiceContext serviceContext) {

		return getPersistence().update(webhook, serviceContext);
	}
	 ...
	 */
	public static List<Webhook> findByUuid(String uuid) {
	 ...
	 */
	public static List<Webhook> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Webhook> findByUuid(
	 ...
	 */
	public static Webhook findByUuid_First(
			String uuid, OrderByComparator<Webhook> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {
	 ...
	 */
	public static Webhook fetchByUuid_First(
		String uuid, OrderByComparator<Webhook> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookException if a matching webhook could not be found
	 */
	public static Webhook findByUuid_Last(
			String uuid, OrderByComparator<Webhook> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {
	 ...
	 */
	public static Webhook fetchByUuid_Last(
		String uuid, OrderByComparator<Webhook> orderByComparator) {
	 ...
	 */
	public static Webhook[] findByUuid_PrevAndNext(
			long webhookId, String uuid,
			OrderByComparator<Webhook> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {

		return getPersistence().findByUuid_PrevAndNext(
			webhookId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchWebhookException if a matching webhook could not be found
	 */
	public static Webhook findByUUID_G(String uuid, long groupId)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {
	 ...
	 */
	public static Webhook fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching webhook, or <code>null</code> if a matching webhook could not be found
	 */
	public static Webhook fetchByUUID_G(
	 ...
	 */
	public static Webhook removeByUUID_G(String uuid, long groupId)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {
	 ...
	 * @return the matching webhooks
	 */
	public static List<Webhook> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching webhooks
	 */
	public static List<Webhook> findByUuid_C(
	 ...
	 * @throws NoSuchWebhookException if a matching webhook could not be found
	 */
	public static Webhook findByUuid_C_First(
	 ...
	 * @return the first matching webhook, or <code>null</code> if a matching webhook could not be found
	 */
	public static Webhook fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Webhook> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookException if a matching webhook could not be found
	 */
	public static Webhook findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Webhook> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {
	 ...
	 * @return the last matching webhook, or <code>null</code> if a matching webhook could not be found
	 */
	public static Webhook fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Webhook> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookException if a webhook with the primary key could not be found
	 */
	public static Webhook[] findByUuid_C_PrevAndNext(
			long webhookId, String uuid, long companyId,
			OrderByComparator<Webhook> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {

		return getPersistence().findByUuid_C_PrevAndNext(
			webhookId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching webhooks
	 */
	public static List<Webhook> findByGroupId(long groupId) {
	 ...
	 * @return the range of matching webhooks
	 */
	public static List<Webhook> findByGroupId(
	 ...
	 * @throws NoSuchWebhookException if a matching webhook could not be found
	 */
	public static Webhook findByGroupId_First(
	 ...
	 * @return the first matching webhook, or <code>null</code> if a matching webhook could not be found
	 */
	public static Webhook fetchByGroupId_First(
		long groupId, OrderByComparator<Webhook> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookException if a matching webhook could not be found
	 */
	public static Webhook findByGroupId_Last(
			long groupId, OrderByComparator<Webhook> orderByComparator)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {
	 ...
	 * @return the last matching webhook, or <code>null</code> if a matching webhook could not be found
	 */
	public static Webhook fetchByGroupId_Last(
		long groupId, OrderByComparator<Webhook> orderByComparator) {
	 ...
	 * @throws NoSuchWebhookException if a webhook with the primary key could not be found
	 */
	public static Webhook[] findByGroupId_PrevAndNext(
	 ...
	 * @throws NoSuchWebhookException if a matching webhook could not be found
	 */
	public static Webhook findByG_WU(long groupId, String webhookURL)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {

		return getPersistence().findByG_WU(groupId, webhookURL);
	}
	 ...
	 * @return the matching webhook, or <code>null</code> if a matching webhook could not be found
	 */
	public static Webhook fetchByG_WU(long groupId, String webhookURL) {
		return getPersistence().fetchByG_WU(groupId, webhookURL);
	}
	 ...
	 * @return the matching webhook, or <code>null</code> if a matching webhook could not be found
	 */
	public static Webhook fetchByG_WU(
		long groupId, String webhookURL, boolean useFinderCache) {

		return getPersistence().fetchByG_WU(
			groupId, webhookURL, useFinderCache);
	}
	 ...
	 * @return the webhook that was removed
	 */
	public static Webhook removeByG_WU(long groupId, String webhookURL)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {

		return getPersistence().removeByG_WU(groupId, webhookURL);
	}
	 ...
	 * @return the number of matching webhooks
	 */
	public static int countByG_WU(long groupId, String webhookURL) {
		return getPersistence().countByG_WU(groupId, webhookURL);
	}
	 ...
	 */
	public static void cacheResult(Webhook webhook) {
		getPersistence().cacheResult(webhook);
	}
	 ...
	 */
	public static void cacheResult(List<Webhook> webhooks) {
		getPersistence().cacheResult(webhooks);
	}
	 ...
	 */
	public static Webhook create(long webhookId) {
	 ...
	 * @throws NoSuchWebhookException if a webhook with the primary key could not be found
	 */
	public static Webhook remove(long webhookId)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {

		return getPersistence().remove(webhookId);
	}

	public static Webhook updateImpl(Webhook webhook) {
		return getPersistence().updateImpl(webhook);
	}
	 ...
	 * @throws NoSuchWebhookException if a webhook with the primary key could not be found
	 */
	public static Webhook findByPrimaryKey(long webhookId)
		throws com.liferay.webhooks.exception.NoSuchWebhookException {
	 ...
	 */
	public static Webhook fetchByPrimaryKey(long webhookId) {
	 ...
	 * @return the webhooks
	 */
	public static List<Webhook> findAll() {
	 ...
	 */
	public static List<Webhook> findAll(int start, int end) {
	...
	public static WebhookPersistence getPersistence() {
		return _persistence;
	}

	private static volatile WebhookPersistence _persistence;
