...
/**
 * Provides the local service interface for Webhook. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WebhookLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface WebhookLocalService
	...
	public Webhook createWebhook(long webhookId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Webhook deleteWebhook(Webhook webhook);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Webhook fetchWebhook(long webhookId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Webhook fetchWebhookByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Webhook getWebhookByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Webhook> getWebhooks(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Webhook> getWebhooksByUuidAndCompanyId(
